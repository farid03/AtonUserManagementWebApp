...
- Доступ к API осуществляется через интерфейс Swagger.
  - Валидация запросов реализована при помощи FluentValidation.

- Все действия сохраняются в базе данных PostgreSQL.
  - для работы с базой данных используется Dapper ORM.
  - для инициализации схемы базы данных и создания пользователя `admin` используется FluentMigrator.
